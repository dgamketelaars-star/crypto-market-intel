...
export const SYSTEM_B_LIMITATIONS: readonly string[] = [
  ...
  'Hyperopt parameters (buy_m1/buy_p1/etc.) were derived by the upstream author on a 1h timerange starting 2021-01-01 with no disclosed out-of-sample or walk-forward validation. Reproduced as-is; not re-tuned for the Top-50 Binance Futures universe.',
